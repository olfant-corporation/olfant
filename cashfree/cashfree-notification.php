...
if ($signature == $computedSignature) {
    if ($txStatus == 'SUCCESS') {
        $sql = "SELECT * FROM gem_form WHERE order_id = '".$orderId."'";
        ...
        $post = [
            ...
            $ch = curl_init('https://crm.webinfinix.com/api/cashfree-notification.php');
        
        
        $sql_select_form = "select `id` from gem_form where order_id = '$orderId'";
        ...
        if($result_select_form->num_rows == 1){
            ...
            form_to_paid($row_select_form['id'],$orderId,$referenceId,$orderAmount + 0,$secretKey);
        }
