...
if (isset($_POST['type']) && ($_POST['type'] == 'edit_submit')) {
    ...
    `created_date`= '".$date."',
    `image`= '".$sql_img_path."',
    `image_alt` = '".mysqli_real_escape_string($conn, $_POST['img_alt'])."',
  ...
  <div class="form mt-4 p-4">
    ...
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="page_title" value="<?php echo $row['page_title'] ?>" required>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" name="head_inc" rows="2" type="text" id="head_inc" required><?php echo $row['head_inc'] ?></textarea>
      </div>
      <div class="form-group">
        <label for="exampleFormControlTextarea1">Schema Mark-up Tag</label>
        <textarea class="form-control" name="schema" rows="10" type="text" id="schema" required><?php echo $row['schema'] ?></textarea>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="hidden" name="img_default_path" accept="image/*" value="<?php echo $row['image'] ?>">
      </div>
      <div class="form-group">
        <label for="exampleFormControlTextarea1">Image's Alt Attribute</label>
        <input type="text" class="form-control" name="img_alt" value="<?php echo $row['image_alt'] ?>" required>
      </div>
      <div class="form-group">
